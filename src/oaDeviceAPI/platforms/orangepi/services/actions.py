...
class ActionsService:
    ...
    async def _execute_script(self, script_name: str, script_dir: Path | None = None) -> tuple[str, bool]:
        """
    ...
    async def _get_available_display_options(self) -> dict[str, list[str]]:
        ...
        try:
            ...
            rates = list({rate for rate in found_rates if int(rate) <= 240})  # Reasonable rate limits
