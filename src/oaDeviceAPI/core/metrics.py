...
from .exceptions import ErrorSeverity, MetricsCollectionError
...
class BaseMetricsCollector(ABC):
    ...
    def __init__(self, platform_provider: PlatformMetricsProvider | None = None):
...
class MetricsCollectorFactory:
    ...
    def create_collector(
        self,
        platform: str,
        provider: PlatformMetricsProvider | None = None
