...
class TestMacOSCamGuardService:
    ...
    async def test_get_camguard_status_success(self, mock_get):
        ...
        from src.oaDeviceAPI.platforms.macos.services.camguard import get_camguard_status
...
class TestMacOSSecurityService:
    ...
    def test_check_firewall_status_success(self, mock_run):
        ...
        from src.oaDeviceAPI.platforms.macos.services.security import check_firewall_status
...
class TestMacOSStandardizedMetrics:
    ...
    def test_get_cpu_info_details(self, mock_machine, mock_cpu_count):
        ...
        from src.oaDeviceAPI.platforms.macos.services.standardized_metrics import get_cpu_details
    ...
    def test_get_network_details(self, mock_addrs, mock_stats):
        ...
        from src.oaDeviceAPI.platforms.macos.services.standardized_metrics import get_network_details
...
class TestMacOSServiceIntegration:
    ...
    def test_service_performance_under_load(self):
        ...
        from src.oaDeviceAPI.platforms.macos.services.system import get_system_info
